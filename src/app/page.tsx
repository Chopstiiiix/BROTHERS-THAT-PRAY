...
export default function HomePage() {
  return (
    <div>
      {/* Hero Section */}
      <section className="relative text-white grunge-texture" style={{ backgroundColor: '#543507' }}>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/live">
                <Button size="lg" variant="outline" className="w-full sm:w-auto !border-white !text-primary-700 !bg-white hover:!bg-gray-100">
                  Watch Live
                </Button>
              </Link>
            </div>
      ...
      {/* CTA Section */}
      <section className="py-16 bg-white border-y-2 border-primary-700">
